...
const Chat = ({ chatId }: { chatId: string }) => {
  ...
  const characterImage = chat.character?.photo ? bytesToBase64(chat.character.photo.data) : null;
  const userImage = chat.user?.profileImage ? bytesToBase64(chat.user.profileImage.data) : null;
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-[#020617] text-white selection:bg-primary/30 scroll-smooth">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto px-4 sm:px-6 pt-6 sm:pt-8 space-y-6 sm:space-y-8 pb-32 sm:pb-40 custom-scrollbar relative"
      >
