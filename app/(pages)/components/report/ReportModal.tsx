            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="absolute inset-0 bg-overlay backdrop-blur-sm transition-all duration-300"
                    />
                    ...
                    <div className="relative z-10 w-full max-w-md px-4">
                        ...
                        >
                            <div className="relative bg-surface border border-border-default shadow-2xl rounded-2xl overflow-hidden p-5">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full h-24 bg-input border border-border-input rounded-xl p-3 text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:border-border-hover resize-none transition-colors"
                                            />
                                            <div className="flex justify-end">
                                                <span className={`text-[10px] font-bold ${details.length > 500 ? 'text-red-500' : 'text-text-muted'}`}>
                                                    {details.length}/500
                                                </span>
                                            </div>
                                        </div>
